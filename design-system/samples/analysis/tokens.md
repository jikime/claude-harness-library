...
> source page: `https://movingbox.example/ko` (home 아키타입, 단일 페이지 1회 관측)
...
| `phone` (시그니처) | 24px | 700~800 | normal | −0.5px | 전화번호 "1600-0000" 강조 |
...
- 구성(스크린샷 근거): 로고(좌) · 텍스트 내비(이사/청소/자가진단/청소대학/꿀팁/인터뷰) · 전화 "1600-0000"(우) · 코랄 CTA 버튼.
